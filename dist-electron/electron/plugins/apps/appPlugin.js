...
export async function executeAppIntent(intent) {
    ...
    if (contextual) {
        ...
        if (!resolved) {
            const hint = contextual === 'active' ? "I'm not sure which app you're referring to. Please specify the app name." :
    ...
    console.log(`[JARVIS_APP] executeAppIntent — type="${intent.type}" ` +
