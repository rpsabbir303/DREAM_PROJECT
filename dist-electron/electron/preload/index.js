...
const api = {
    ...
    ai: {
        ...
        markObservabilityNotificationRead: (notificationId) => ipcRenderer.invoke(IPC_CHANNELS.observabilityMarkNotificationRead, notificationId),
        ...
        setLearningRecommendationStatus: (payload) => ipcRenderer.invoke(IPC_CHANNELS.learningSetRecommendationStatus, payload),
