...
import type { AgentPerformanceMetric, MultiAgentSession, SpecializedAgentId } from '../../shared/interfaces/ipc.js'
...
export class MultiAgentCoordinator {
  private sessions: MultiAgentSession[] = []
  private performance = new Map<SpecializedAgentId, { runs: number; totalLatencyMs: number; success: number }>()
  ...
  async run(goal: string): Promise<MultiAgentSession> {
  ...
  getPerformanceMetrics(): AgentPerformanceMetric[] {
  ...
  private track(agentId: SpecializedAgentId, latencyMs: number, success: boolean) {
