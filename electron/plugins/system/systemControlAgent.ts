...
export async function volumeMute(): Promise<OpResult> {
  try {
...
export async function volumeSet(level: number): Promise<OpResult> {
...
export async function volumeIncrease(steps = 5): Promise<OpResult> {
  try {
...
export async function volumeDecrease(steps = 5): Promise<OpResult> {
  try {
    const repeats = Math.min(steps, 20)
...
export async function setBrightness(level: number): Promise<OpResult> {
  const clamped = Math.max(0, Math.min(100, level))
  try {
...
export async function takeScreenshot(): Promise<OpResult> {
  try {
...
export async function lockScreen(): Promise<OpResult> {
  try {
...
export async function shutdownPC(delaySec = 5): Promise<OpResult> {
  try {
...
export async function restartPC(delaySec = 5): Promise<OpResult> {
  try {
...
export async function sleepPC(): Promise<OpResult> {
  try {
...
export async function cancelShutdown(): Promise<OpResult> {
  try {
...
export async function setWifi(on: boolean): Promise<OpResult> {
  try {
...
export async function setBluetooth(on: boolean): Promise<OpResult> {
  try {
    const ps = `
...
`
    ...
    if (stdout.includes('not_found')) return { ok: false, message: 'Bluetooth device not found.' }
...
export async function getClipboard(): Promise<OpResult> {
  try {
...
export async function clearClipboard(): Promise<OpResult> {
  try {
