...
const api: JarvisDesktopApi = {
  ...
  automation: {
    ...
    directExec: (type: string, params: Record<string, string>) =>
      ipcRenderer.invoke(IPC_CHANNELS.automationDirectExec, { type, params }),
  ...
  aiHealth: {
    ...
    setApiKey: (key: string) => ipcRenderer.invoke(IPC_CHANNELS.aiSetApiKey, key),
  },
}
