...
export function readProcessEnv(name: string): string | null {
...
export function looksLikeOpenAiSecretKey(key: string): boolean {
  const t = key.trim()
...
export function getEffectiveOpenAiApiKey(): string | null {
...
export function canUseConfiguredOpenAi(): boolean {
